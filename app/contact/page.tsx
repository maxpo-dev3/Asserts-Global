...
export default function ContactForm() {
  ...
  return (
    <div className=" text-gray-800 max-h-[85vh] container mx-auto overflow-y-auto flex justify-start py-10">
        ...
        <form className="space-y-5 md:space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                className="bg-gray-100 border border-gray-300 text-gray-800 placeholder:text-gray-400 py-6 "
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              >
                <SelectTrigger className="bg-gray-100 border border-gray-300 text-gray-800 w-full py-6">
          ...
          <div>
            ...
            <Textarea
              ...
              className="bg-gray-100 border border-gray-300 text-gray-800 placeholder:text-gray-400 py-6 min-h-[100px]"
            />
          </div>
          ...
          <Button
            type="submit"
            className="w-full bg-[#7AB945] cursor-pointer text-white py-6 rounded-4xl"
          >
            Send Enquiry
          </Button>
        </form>
