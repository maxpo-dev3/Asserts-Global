    ...
    <section className="py-12 md:py-16 bg-gradient-to-b from-[#07173A] to-[#7AB945] text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          {/* Left Column */}
          <div>
            <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">Let's Discuss Your Investment Goals</h3>
            ...
            <div className="bg-white/70 text-black rounded-lg p-4 md:p-6">
              <h4 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Why Choose Assets Global?</h4>
