...
const opportunities = [
  {
    ...
    features: [
      "2x Asset Backed",
      "Minimum Investment @ ₹1Cr Onwards",
      "Tenure 2-3 Years",
      "Target IRR 22%",
    ],
    bgColor: "bg-[#07173A]",
  ...
  },
  {
    ...
    features: [
      "1.3x Asset Backed",
      "Minimum Investment @ ₹30L",
      "Tenure 2 Years",
      "Fixed Returns 14%P.A",
    ],
    bgColor: "bg-[#07173A]",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-4xl mx-auto">
            Curated High-Yield Real Estate Investments Designed Specifically For
            High Net Worth Individuals Seeking Superior Returns With Calculated
            Risks.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-10 md:mb-12 ">
          {opportunities.map((opportunity, index) => (
            <div
              key={index}
              className={`${opportunity.bgColor} text-white rounded-4xl p-6 md:p-8 flex flex-col justify-between`}
            >
              <>
                <h3 className="text-lg md:text-xl font-bold mb-4 md:mb-6 leading-tight">
                  {opportunity.title}
                </h3>
        ...
        <div className="text-center py-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-slate-800 hover:bg-slate-700 text-white px-6 py-3 rounded-4xl cursor-pointer" onClick={() => router.push("/contact")}>
