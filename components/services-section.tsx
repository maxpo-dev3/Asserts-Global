...
const developerServices: Service[] = [
  {
    ...
    description:
      "AI Marketing Technology Delivers Verified, High-Intent Prospects Shorten Sales Cycles",
  },
  {
    image: settingsIcon,
...
const investmentServices: Service[] = [
  {
    ...
    title: "Curated Deals",
    description:
      "Exclusive Access To Early Stage Real Estate Investments Off-Market Deals",
  },
  {
    image: fileCheckIcon,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto">
            Comprehensive Real Estate Solutions For Developers And Investors,
        ...
        <div className="pt-5">
          <h3 className="text-2xl sm:text-3xl md:text-4xl  font-bold text-slate-800 text-center mb-12">
            For Real Estate Developers
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {developerServices.map((service, index) => (
              <div
                key={index}
                className="bg-white pl-6 pr-6 pt-0 pb-6 shadow-lg border-4 border-black  rounded-tl-[0px] rounded-tr-[0px] rounded-bl-4xl rounded-br-4xl flex flex-col items-center text-center"
              >
                <div className="w-20 h-15 bg-[#07173A] rounded-b-4xl flex items-center justify-center mb-6">
                  <Image
                    src={service.image}
                    alt={service.title}
                    width={40}
        ...
        <div className="py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {investmentServices.map((service, index) => (
              <div
                key={index}
                className="bg-white pl-6 pr-6 pt-0 pb-6 shadow-lg border-4 border-black  rounded-tl-4xl rounded-tr-4xl rounded-bl-[0px] rounded-br-[0px] flex flex-col items-center text-center"
              >
                <div className="w-20 h-15 bg-[#07173A] rounded-b-4xl flex items-center justify-center mb-6 ">
                  <Image
                    src={service.image}
